              ...
              {results.map((employee) => (
                ...
                >
                  <div className="min-w-0">
                    <p className="truncate text-sm font-semibold text-gray-900">{employee.employee_name || '-'}</p>
                    <p className="truncate text-xs text-gray-500">{employee.employee_email || 'No email found'}</p>
                  </div>
